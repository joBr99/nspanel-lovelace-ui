translations = {
    ...
    'el_GR': {
        ...
        'idle': "Σε Αναμονή",
        'off': "Κλειστό",
        'arm_away': "Συναγερμ. Εκτός",
        'arm_custom_bypass': "Παρέμβαση Χρήστη",
        'arm_home': "Συναγερμ. Εντός",
        'arm_night': "Συναγερμ. Νύχτα",
        'arm_vacation': "Συναγερμ. Διακοπών",
        'clear_code': "Επαναφορά",
        'code': "Κωδικός",
